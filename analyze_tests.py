...
def get_results(project_name=None, bug_id=None):
    visitor = Visitor()
...
def print_results(visitor):
    ...
    print(f"Total assertions: {sum(visitor.assertions_per_test)}")
    print(f"Average tests per subject: {average_tests_per_subject}")
    print(f"Average assertions per test: {average_assertions_per_test}")
    print(f"Average lines per test: {average_lines_per_test}")
...
if __name__ == "__main__":
    ...
    get = command.add_parser("get", help="get values of all subjects")
    analyze = command.add_parser("analyze", help="analyze values")

    get.add_argument(
        "-p", type=str, default=None, dest="project_name", help="project name"
    )
    get.add_argument("-i", type=int, default=None, dest="bug_id", help="bug id")
    ...
    if arguments.command == "get":
        get_results(project_name=arguments.project_name, bug_id=arguments.bug_id)
